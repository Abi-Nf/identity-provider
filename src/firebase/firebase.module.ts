...
const provider: FactoryProvider<admin.app.App> = {
...
@Module({
  ...
  providers: [provider, FirebaseRepository, FirebaseService, FirebaseGuard],
  exports: [FirebaseRepository, FirebaseService, FirebaseGuard],
})
